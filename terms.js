...
(function (global) {
  const TERMS_VERSION = '2026-07-25-v4';
      ...
      <div class="terms-doc">
        ...
        <div class="terms-list">
          ...
          <article class="terms-item">
            ...
            <p data-ar="لا نبيع بياناتكم ولا نشاركها لأغراض تسويق طرف ثالث. قد يُستعان بمعالجين ضروريين فقط لتقديم الخدمة، مثل: استضافة قواعد البيانات والمصادقة (Supabase)، بوابة الدفع (Moyasar)، وخدمات بريد تشغيلية عند تفعيل التنبيهات، وشبكات توصيل محتوى/خطوط عند الحاجة. يلتزم هؤلاء بالغرض التشغيلي وفق إعداداتهم الأمنية والتعاقدية." data-en="We do not sell your data or share it for third-party marketing. Essential processors may be used only to deliver the service, such as: database and auth hosting (Supabase), the payment gateway (Moyasar), operational email when alerts are enabled, and CDN/font providers when needed. They process data for the operational purpose under their security and contractual settings.">لا نبيع بياناتكم ولا نشاركها لأغراض تسويق طرف ثالث. قد يُستعان بمعالجين ضروريين فقط لتقديم الخدمة، مثل: استضافة قواعد البيانات والمصادقة (Supabase)، بوابة الدفع (Moyasar)، وخدمات بريد تشغيلية عند تفعيل التنبيهات، وشبكات توصيل محتوى/خطوط عند الحاجة. يلتزم هؤلاء بالغرض التشغيلي وفق إعداداتهم الأمنية والتعاقدية.</p>
          </article>
          <article class="terms-item">
