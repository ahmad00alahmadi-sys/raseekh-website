      ...
      <div class="terms-doc">
        ...
        <div class="terms-list">
          ...
          <article class="terms-item">
            ...
            <p data-ar="خيارات الاستضافة تُحدد في العرض: بيئة سحابية متفق عليها (مثل STC Cloud أو AWS) أو خوادم العميل. نراعي متطلبات التشغيل وأمن الوصول، ونتعامل مع البيانات الشخصية وفق أنظمة المملكة بما فيها نظام حماية البيانات الشخصية (PDPL) بالقدر المنطبق على الخدمة." data-en="Hosting options are set in the quote: an agreed cloud environment (such as STC Cloud or AWS) or the client’s servers. We consider ops needs and access security, and handle personal data under Saudi rules including PDPL to the extent applicable to the service.">خيارات الاستضافة تُحدد في العرض: بيئة سحابية متفق عليها (مثل STC Cloud أو AWS) أو خوادم العميل. نراعي متطلبات التشغيل وأمن الوصول، ونتعامل مع البيانات الشخصية وفق أنظمة المملكة بما فيها نظام حماية البيانات الشخصية (PDPL) بالقدر المنطبق على الخدمة.</p>
          </article>
          <article class="terms-item">
    ...
    return `
      <div class="terms-doc">
        ...
        <div class="terms-list">
          ...
          <article class="terms-item">
            <h3 data-ar="6) حقوقكم والتواصل" data-en="6) Your rights and contact">6) حقوقكم والتواصل</h3>
            <p data-ar="يمكنكم طلب تصحيح بيانات التواصل أو الاستفسار عن المعالجة عبر نموذج التواصل أو حساب العميل. تخضع المعالجة لأنظمة المملكة بما فيها PDPL بالقدر المنطبق. راجعوا أيضاً الشروط والأحكام." data-en="You may request correction of contact data or ask about processing via the contact form or client account. Processing follows Saudi rules including PDPL to the extent applicable. See also the Terms & Conditions.">يمكنكم طلب تصحيح بيانات التواصل أو الاستفسار عن المعالجة عبر نموذج التواصل أو حساب العميل. تخضع المعالجة لأنظمة المملكة بما فيها PDPL بالقدر المنطبق. راجعوا أيضاً الشروط والأحكام.</p>
          </article>
        </div>
      </div>
    `;
