      ...
      <div class="terms-doc">
        ...
        <div class="terms-list">
          <article class="terms-item">
            ...
            <p data-ar="تقدّم راسخ خدمات تقنية إلكترونية تشمل: صيانة المواقع، تطوير وتعديل البرمجة، تطبيقات المخزون والأنظمة التشغيلية، ربط الأنظمة وواجهات API، وبناء لوحات تحكم حسب احتياج العميل. نطاق كل عمل يُحدد كتابةً في عرض السعر أو الاتفاق المعتمد قبل التنفيذ." data-en="Raseekh provides digital technical services including website maintenance, programming and code changes, inventory apps and operational systems, API/system integrations, and custom dashboards. Scope is written in the approved quote or agreement before work starts.">تقدّم راسخ خدمات تقنية إلكترونية تشمل: صيانة المواقع، تطوير وتعديل البرمجة، تطبيقات المخزون والأنظمة التشغيلية، ربط الأنظمة وواجهات API، وبناء لوحات تحكم حسب احتياج العميل. نطاق كل عمل يُحدد كتابةً في عرض السعر أو الاتفاق المعتمد قبل التنفيذ.</p>
          </article>
          <article class="terms-item">
